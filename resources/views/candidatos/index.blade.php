  ...
  @if (count($vacante->candidatos) > 0)
    <ul class="max-w-md mx-auto mt-10">
        @foreach ($vacante->candidatos as $candidato)
            <li class="p-5 border boder-gray-400 mb-5">
                <p class="mb-4">Nombre:
                ...
                <a class="bg-teal-500 p-3 inline-block text-block text-xs font-bold uppercase text-white" href="/storage/cv/{{$candidato->cv}}">
                 Ver cv
                </a>
            </li>
        @endforeach

                ...
                <form class="py-10 px-5" method="POST" action="{{ route('password.update') }}" novalidate>
                    ...
                    <div class="flex flex-wrap mb-6">
                        <label for="email" class="block text-gray-700 text-sm mb-2">{{ __('E-Mail Address') }}</label>
                            ...
                            <input id="email" type="email" class="p-3 bg-gray-300 rounded form-input w-full @error('email') border-red-500 border @enderror" name="email" value="{{ $email ?? old('email') }}"  autocomplete="email" autofocus>
                    ...
                    <div class="flex flex-wrap mb-6">
                        <label for="password" class="block text-gray-700 text-sm mb-2">{{ __('Password') }}</label>
                            ...
                            <input id="password" type="password" class="p-3 bg-gray-300 rounded form-input w-full @error('password') border-red-500 border @enderror" name="password" autocomplete="new-password">
                    ...
                    <div class="flex flex-wrap mb-6">
                        <label for="password-confirm" class="block text-gray-700 text-sm mb-2">{{ __('Confirm Password') }}</label>
                            <input id="password-confirm" type="password" class="p-3 bg-gray-300 rounded form-input w-full" name="password_confirmation" autocomplete="new-password">
                    </div>

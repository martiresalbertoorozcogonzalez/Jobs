    ...
    <div class="container mx-auto max-w-screem-md">
        <div class="flex flex-wrap justify-center">
                        ...
                        <form class="py-10 px-5" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input id="password-confirm" type="password"
                                    class="p-3 bg-gray-300 rounded form-input w-full" name="password_confirmation" required
            ...
            <div class="md:w-1/2 order-1 md:order-2 text-center flex flex-col justify-center px-10 mt-10">
                ...
                <p class="text-xl mt-5 leading-7">Crea una cuenta gratis y publica hasta 10 vacantes</p>
            </div>
